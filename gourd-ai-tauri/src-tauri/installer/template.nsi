...
;   3) 该 Function 内的 Call GWorkApplyFonts 用 !ifdef GWORK_APPLY_FONTS_DEFINED 守卫
...
!define MUI_PAGE_CUSTOMFUNCTION_PRE SkipIfPassive
!define MUI_PAGE_CUSTOMFUNCTION_SHOW GWorkNativePageShow
...
FunctionEnd
; ── GWork：原生页（directory/finish）show 回调同步扫控件；扫逻辑在 hooks.nsh 的 GWorkApplyFonts ──
...
!ifdef GWORK_APPLY_FONTS_DEFINED
  Call GWorkApplyFonts
!endif
FunctionEnd
