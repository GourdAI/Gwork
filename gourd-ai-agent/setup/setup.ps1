...
try {
    ...
    $env:GOURDWORK_INSTALL_DIR = $installDir
    ...
    Write-Host "gourdai cli" -ForegroundColor Cyan -NoNewline
    Write-Host " or " -NoNewline
    Write-Host "gourdai web 0" -ForegroundColor Cyan
    Write-Host ""
