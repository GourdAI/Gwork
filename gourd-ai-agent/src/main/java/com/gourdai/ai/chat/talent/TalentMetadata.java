 ...
 */
package com.gourdai.ai.chat.talent;
...
public class TalentMetadata implements Serializable {
    ...
    public TalentMetadata(String name, String description) {
        this.name = name;
    ...
    public TalentMetadata description(String description) {
        this.description = description;
        return this;
    }

    public TalentMetadata category(String category) {
        this.category = category;
        return this;
    }

    public TalentMetadata tags(String... tags) {
        this.tags = tags;
        return this;
    }

    public TalentMetadata sensitive(boolean sensitive) {
