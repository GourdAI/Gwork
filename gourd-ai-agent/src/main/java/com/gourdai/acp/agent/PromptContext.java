...
public interface PromptContext {
	 ...
	 * @throws com.gourdai.acp.error.AcpCapabilityException if client doesn't support file reading
	 */
	 ...
	 * @throws com.gourdai.acp.error.AcpCapabilityException if client doesn't support file writing
	 */
	 ...
	 * @throws com.gourdai.acp.error.AcpCapabilityException if client doesn't support terminals
	 */
