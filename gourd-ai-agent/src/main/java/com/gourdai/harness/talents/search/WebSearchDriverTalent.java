 ...
 */
@Preview("3.9.1")
public class WebSearchDriverTalent extends AbsTalent {
    private static final Logger LOG = LoggerFactory.getLogger(WebSearchDriverTalent.class);

    private final String apiKey;
    private final SearchDriver driver;
    private int maxResults = 5;

    public WebSearchDriverTalent(SearchDriver driver, String apiKey) {
        this.driver = driver;
        this.apiKey = apiKey;
    }

    public WebSearchDriverTalent maxResults(int maxResults) {
        this.maxResults = maxResults;
        return this;
    }

    @ToolMapping(name = "web_search", description = "联网搜索，返回标题、链接和摘要")
    public String web_search(@Param("query") String query) {
